...
d3.json(url).then(function(data) {
  console.log(data);
         ...
         // ******************************************************************************* //
        // ********************* FUNCTION: STARTS THE ID DROPDOWN LIST ******************* //
       // ******************************************************************************* //
...
function init() {
    ...
    d3.json(url).then((data) => {
        ...
        buildGaugeChart(sample_one);
         ...
         // ********************************************************************************* //
        // ********************* FUNCTION: STARTS ID DEMOGRAPHIC INFO ********************** //
       // ********************************************************************************* //
...
function buildMetadata(sample) {
    ...
    d3.json(url).then((data) => {
        ...
        Object.entries(valueData).forEach(([key,value]) => {
         ...
         // ****************************************************************************************** //
        // ********************* FUNCTION: UPDATE DATA WITH CHANGING SAMPLE ID ********************** //
       // ****************************************************************************************** //
...
// };
          ...
          // **************************************************************************************** //
        // ************************ FUNCTION: CALL INITIALIZED FUNCTION **************************** //
       // ***************************************************************************************** //
